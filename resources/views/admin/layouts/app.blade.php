            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link {{ Request::path() === 'project' ? 'active' : '' }}" href="">Project</a></li>
                  <li class="nav-item"> <a class="nav-link {{ Request::path() === 'skill' ? 'active' : '' }}" href="{{ route('admin.skill') }}">Daftar Skill</a></li>
                </ul>
              </div>
            </li>
          </ul>
